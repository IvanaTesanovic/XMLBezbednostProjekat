...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:ww="http://www.skupstinans.rs"
    ...
    <xsl:template match="/">
        <fo:root>
            <fo:layout-master-set>
                <fo:simple-page-master master-name="zakon-page">
                    <fo:region-body margin="1in"/>
                </fo:simple-page-master>
            </fo:layout-master-set>
            
            <fo:page-sequence master-reference="zakon-page">
                <fo:flow flow-name="xsl-region-body">
                
                    <fo:block font-family="sans-serif" font-size="32px" font-weight="bold" padding="30px">
                       <xsl:value-of select="ww:Zakon/ww:ID"/> AKT <xsl:value-of select="Naziv"/> 
                    </fo:block>
